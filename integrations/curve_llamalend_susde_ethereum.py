...
class CurveLlamaLendsSUSDeEthereum(Integration):
    def __init__(self):
        super().__init__(
            integration_id=IntegrationID.CURVE_SUSDE_BORROWERS,
            start_block=curve_constants.CURVE_LLAMALEND_ETHEREUM_SUSDE_GENESIS_BLOCK,
    ...
    def get_balance(self, user: str, block: int) -> float:
        ...
        user_state = call_with_retry(
            curve_utils.curve_llamalend_susde_controller_contract.functions.user_state(user),
            block,
        )
