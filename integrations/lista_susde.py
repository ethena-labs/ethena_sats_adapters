...
lista_api_url_mainnet = "https://api.lista.org/api/moolah/ethena/position?token=susde&block={blockNumber}"
...
if __name__ == "__main__":
    lista_integration = ListaProtocolIntegration(
        integration_id=IntegrationID.LISTA_SUSDE,
        start_block=48172369,
        summary_cols=[SummaryColumn.LISTA_SUSDE_PTS],
    ...
    print(
        lista_integration.get_block_balances(
            cached_data={}, blocks=[38172369, 50724110, 50724112]
        )
    )
