...
# Contract or first pair deployment block heights
...
USDE_TOKEN_ADDRESS_BY_CHAIN = defaultdict(
    lambda: USDE_TOKEN_ADDRESS_FOR_L2, {
...
SUSDE_TOKEN_ADDRESS_BY_CHAIN = defaultdict(
    lambda: SUSDE_TOKEN_ADDRESS_FOR_L2, {
